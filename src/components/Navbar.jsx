...
export default function Navbar(props) {
  ...
  return (
    <nav
      className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode} style={myStyle}`} style={myStyle}
    >
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        >
          ...
          <label className="switch">
            ...
            <input type="checkbox" className="input" onClick={props.toggleMode}/>
            <span className="slider"></span>
          </label>
          <label className="form-check-label mx-3 my-1" htmlFor="flexSwitchCheckDefault">
            {mode} Mode Enabled
          </label>
